        ...
        <>
            {success ? (
                <div className='flex justify-center items-center flex-col mt-20  '>
                    <p className='bg-green-600 text-white'>User has been successfully created</p>
                    <Link to='/login' className=''>Sign in</Link>
                </div>
            ) : (
                <div className='flex justify-center items-center flex-col mt-20  '>
                    <h1 className={success ? 'hidden' : ''}>Register</h1>
                    <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center w-64 bg-gray-400 p-4'>
