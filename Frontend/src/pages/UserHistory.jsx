...
function ArticleData() {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className="flex flex-col justify-center items-center bg-cyan-500 p-4 rounded-lg mt-20">
                <form onSubmit={getNewData} className="flex flex-col border-b-2 p-2 border-slate-900 ">
